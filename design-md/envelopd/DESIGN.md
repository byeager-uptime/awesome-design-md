...
- **Near Black** (`#08080D`): `--pocket-accent-foreground` (alias: `--pocket-accent-fg`). Text on accent backgrounds. Dark text on mint passes WCAG AA at 10.31:1 contrast ratio.
